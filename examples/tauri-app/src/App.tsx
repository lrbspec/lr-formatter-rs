  ...
  return (
    <main style={rootStyle}>
      <div style={containerStyle}>
        ...
        <FormatConvertPrompt
          initialFormatFrom={formatFrom}
          onFormatFromChange={setFormatFrom}
          onFormatToChange={setFormatTo}
        />

        <ConvertButton file={selectedFile} fromFormat={formatFrom} toFormat={formatTo} />
      </div>
    </main>
  );
}
